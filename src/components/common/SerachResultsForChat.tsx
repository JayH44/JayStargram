...
function SerachResultsForChat({ input, onClick }: SerachResultsProps) {
    ...
    <Container>
      {snapshot &&
        snapshot.docs.map((docSnapshot) => {
          ...
          return (
            <SerachItem key={docSnapshot.id} onClick={() => onClick?.(data.id)}>
...
`;
SerachResultsForChat.defaultProps = {};

export default SerachResultsForChat;
